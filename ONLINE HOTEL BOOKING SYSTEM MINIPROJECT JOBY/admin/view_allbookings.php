...
$id = $_REQUEST['id'];
 $sql="select * from carreservation where status='1'";
$res=$obj->exe($sql);
...
while($r=mysqli_fetch_array($res)){
    ...
    <td>&nbsp;<?php echo $r[4];?>&nbsp;</td>
    <td>&nbsp;<?php echo $r[5];?>&nbsp;</td>
<td><a href="delete_carreserve.php?id=<?php echo $r[0];?>">
    <img src="../uploads/delete_button.jpg" width="80"/></a><a href="confirm_carreserve.php?id=<?php echo $r[0];?>">
...
<table border="1" align="center" >
  ...
  <?php
$id = $_REQUEST['id'];
 $sql="select * from carreservation where status='1'order by $id";
 $res=$obj->exe($sql);
  $no=mysqli_num_rows($res);
