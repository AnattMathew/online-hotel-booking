...
<!-- single -->
 <br /><br /><h2 align="center" style="color:#036FC7;font-family:Impact, Haettenschweiler, 'Franklin Gothic Bold', 'Arial Black', sans-serif;">ROOM RESERVATION</h2><br /><br />
  <form enctype="multipart/form-data" method="post" action="addreservation.php">
          <div style="width:20%;">
